...
@section('content')
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe06b;</i><span>欢迎登录网站后台</span></div>
        </div>
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    ...
                    <li>
                        <label class="res-lab">设计-版本</label><span class="res-info">v-1.0</span>
                    </li>
                    <li>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    <li>
                        <label class="res-lab">QQ交流：347501534</label>
                    </li>
                </ul>
            </div>
        </div>
